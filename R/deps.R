...
addDeps <- function(x) {
  ...
  dashboardDeps <- list(
    ...
    htmltools::htmlDependency(
      name = "argonDash",
      version = as.character(utils::packageVersion("argonDashMod")),
      src = c(file = system.file("argonDash-0.1.0", package = "argonDashMod")),
      script = argonDash_js
    ),
    # bootstrap deps
    htmltools::htmlDependency(
      name = "bootstrap", 
      version = "4.1.3",
      src = c(file = system.file("bootstrap-4.1.3", package = "argonDashMod")),
      script = bootstrap_js
    ),
    # google fonts
    htmltools::htmlDependency(
    ...
    htmltools::htmlDependency(
      ...
      src = c(file = system.file("nucleo-0.1.0", package = "argonDashMod")),
    ...
    htmltools::htmlDependency(
      name = "fontawesome", 
      version = "5.3.1",
      src = c(file = system.file("fontawesome-5.3.1", package = "argonDashMod")),
    ...
    htmltools::htmlDependency(
      name = "argon", 
      version = "1.0.0",
      src = c(file = system.file("argon-1.0.0", package = "argonDashMod")),
